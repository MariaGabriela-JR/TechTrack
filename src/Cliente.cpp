...
string Cliente::getRazaoSocial() const {return razao_social;}
string Cliente::getCnpj() const {return cnpj;}
...
string Cliente::getRamoDeNegocio() const {return ramo_de_negocio;}
...
int Representante::getId() const {return id;}
string Representante::getNome() const {return nome;}
string Representante::getEmail() const {return email;}
string Representante::getTelefone() const {return telefone;}
string Representante::getCpf() const {return cpf;}
